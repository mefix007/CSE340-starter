...
ALTER TYPE public.account_type OWNER TO mefix007;
--2. create 'classificcation" table
...
--4. add foreign key to 'inventory' table
ALTER TABLE IF EXISTS public.inventory
ADD CONSTRAINT classification_fk FOREIGN KEY (classification_id) REFERENCES public.classification (classification_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION;
...
--6. insert data to 'classification' table
...
VALUES ('Custom'),
    ...
    ('Truck'),
    ('Sedan');
--7. insert data to 'inventory' table
